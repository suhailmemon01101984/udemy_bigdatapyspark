...
total_spend_by_customer=customerid_n_spendamounts.reduceByKey(lambda x,y:x+y).sortBy(lambda x:x[1]) # this command will total the spend by customer and then sort the results by the second column which is the spend.
